...
//##############################################################################
 ...
 //   uMyo.begin(); 
    ...
    BLE.begin();
 //   BLE.setEventHandler(BLEDiscovered, GetupdatedIMUdata); 
...
//  BLEDevice peripheral = BLE.available();
  ...
  // see if peripheral is a Specific Peripheral, WITH Specific name 
    if (peripheral.localName() == "IMUBatt") {
      // stop scanning
     Serial.println("BLE Local Name") ;
     Serial.println(peripheral.localName()) ;
     BLE.stopScan();
     delay(1000) ;
     while (1) {
        // Update data from Peripheral
...
//Servo control Routines 
  ...
  /*
      ...
      */
      ...
      //Print Umayo Data
      // Serial.println("Checked one loop") ; 
      //  Serial.print("MuscleDataXXX") ;
        Serial.print(MuscleData1) ;
        Serial.println() ;
...
// int 
  dev_count  = uMyo.getDeviceCount(); //if more than one device is present, show all of them
    
  for(int d = 0; d < dev_count; d++)
  {
   
   MuscleData1 = dev_count*(uMyo.getMuscleLevel(d)) ;

    if(d < dev_count-1) Serial.print(' ');
    else Serial.println();
  }

   MuscleData1 = dev_count* MuscleData1 ;
   Serial.println("MuscleDatainuMyoLoop") ;
   Serial.println(MuscleData1) ;
